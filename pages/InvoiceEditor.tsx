...
const InvoiceEditor: React.FC = () => {
  ...
  const executeTransmission = async (recipientEmail: string, emailBody: string, recipientName?: string) => {
    ...
    // --- EMAILJS CONFIG ---
    const EMAILJS_SERVICE_ID = 'service_eki14se'; 
    const EMAILJS_TEMPLATE_ID = 'template_tg5pymr'; 
    const EMAILJS_PUBLIC_KEY = 'SRove_ciDKhUF5QGu'; 
    ...
    const payload = JSON.stringify({
        ...
        template_params: {
            ...
            to_name: recipientName || invoice.client,
