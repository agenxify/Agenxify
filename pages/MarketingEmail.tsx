...
const MarketingEmail: React.FC = () => {
  ...
  const handleSend = async () => {
    ...
    if (isDirectMail) {
        ...
        // EmailJS Config (From Invoice Terminal)
        const SERVICE_ID = 'service_eki14se';
        const TEMPLATE_ID = 'template_tg5pymr';
        const PUBLIC_KEY = 'SRove_ciDKhUF5QGu';
