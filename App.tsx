                ...
                <div className="relative" ref={profileRef}>
                  ...
                  {isProfileOpen && (
                    <div className="absolute right-0 top-full mt-2 w-56 bg-white dark:bg-zinc-900 border border-slate-100 dark:border-zinc-800 rounded-2xl shadow-xl z-50 overflow-hidden animate-in fade-in zoom-in-95 duration-200 p-1">
                      ...
                      <button onClick={() => { setIsProfileOpen(false); window.dispatchEvent(new CustomEvent('open_cookie_preferences')); }} className="w-full px-4 py-2.5 text-left text-xs font-bold text-slate-600 dark:text-zinc-400 hover:bg-slate-50 dark:hover:bg-zinc-800 rounded-xl flex items-center gap-2 transition-colors"><Shield size={14} /> Privacy & Cookies</button>
